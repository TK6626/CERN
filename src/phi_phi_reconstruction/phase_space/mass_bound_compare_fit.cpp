...
//	leg->AddEntry(frame->findObject("argus"), "Background (ARGUS)", "l");
	...
	SaveRooFitObjects(c1, rooObjects, TString::Format("media/root_files/phi_phi_reconstruction/phase_space/mass_cuts/%s/compare_topologies/fit_bound = %.3g MeV.root", branch, val), frame, "canavs");
	return 0;
}
