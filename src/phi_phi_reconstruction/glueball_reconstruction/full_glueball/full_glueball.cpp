...
// !./bashing/run_file.sh phi_phi_reconstruction/glueball_reconstruction/full_glueball
...
int main() {
	...
	// Combine signal and background
		...
		SaveCanvas(can, dat, TString::Format("media/root_files/phi_phi_reconstruction/glueball_reconstruction/full_glueball/"+ topo +"/mass_bound=%.3g_MeV.root", mass_bound*1e3), "RECREATE");
